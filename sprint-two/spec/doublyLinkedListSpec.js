describe('doublyLinkedList', function() {
  ...
  it('should set the new head\'s previous property to null when removeHead is called', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
  ...
  it('should set list head and tail to null if removing the last element', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.removeHead();
